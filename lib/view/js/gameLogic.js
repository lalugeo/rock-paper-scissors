/* global angular */
const gameLogic = angular.module('gameApp', ['ngRoute']);

gameLogic.config(($routeProvider) => {
  $routeProvider
    .when('/', {
      templateUrl: 'lib/view/html/newGame1.html',
      controller: 'gameController',
    })

    .when('/match', {
      templateUrl: 'lib/view/html//match.html',
...
gameLogic.controller('rpsController', ($scope, $window, $http) => {
